...
<script>
    ...
    function viewRes(id) {
        ...
        console.log(url)
        splitUrl = url.split('/')
        msg= splitUrl[splitUrl.length - 1]
        console.log(msg)
        ...
        if(msg == "StdUserID") {
            window.location.href = "useridPassStudent.php?"+ "/"  + examCode ;
        }else if (msg == "StdDetails") {
            window.location.href = "studentDetails.php?"+ "/"  + examCode ;   
        }else {
