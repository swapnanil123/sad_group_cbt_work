            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Student Menu</h1>
                        <div class="row">
                        	<div id="layoutAuthentication">
					            <div id="layoutAuthentication_content">
					                <main>
					                    <div class="d-grid gap-4 col-6 mx-auto m-5">
                                            <button class="btn btn-warning" type="button"><a href="examList.php" style="text-decoration: none; color: #fff">Exam-wise Student Details</a></button>
                                            <button class="btn btn-danger" type="button" ><a href="examList.php" style="text-decoration: none; color: #fff">Student User ID & Password</a></button>
                                        </div>
					                </main>
					            </div>
					        </div>
